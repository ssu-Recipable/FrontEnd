...
const ChooseIngredients = () => {
    ...
    useEffect(() => {
        if (data) {
            const ingredients = data.flatMap(category => 
                category.refrigeratorDetailList?.map(detail => detail.ingredientName) || []
            );
                            ...
                            <Category>
                                ...
                                <IngredientList>
                                    {category.refrigeratorDetailList?.map((ingredient) =>
                                        <Ingredient onClick={()=>handleIngredientClick(ingredient.ingredientName)}>
                                            {ingredient.ingredientImage? 
                                                <IngredientImg src={ingredient.ingredientImage} isSelected={selectedIngredients.includes(ingredient.ingredientName)}/>
                                                : <DefaultImg src={DefaultIngredientImg} isSelected={selectedIngredients.includes(ingredient.ingredientName)}/>
                                            }
