                    ...
                    <>
                        ...
                        <InfoSection>
                            ...
                            <IconSection>
                                ...
                                <svg onClick={handleBookmarkClick} style={{ cursor: "pointer" }} xmlns="http://www.w3.org/2000/svg" fill={isBookmarked? "#FFEB57" : "#E6E6E6"} viewBox="0 0 24 24" strokeWidth="2" stroke={isBookmarked? "#FFEB57" : "#E6E6E6"} width="24">
                        ...
                        <VideoSection>
                            ...
                            <Videos>
                                {data.recipeVideoResponses.map((video, index) => 
                                    <Video key={index}>
